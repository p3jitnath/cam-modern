...
\newlength\CoverSidePad     \setlength\CoverSidePad{2.9\parindent}       % left/right padding
...
\address[1]{\orgdiv{Department}, \orgname{University}, \orgaddress{\country{Country}}}
\address[2]{\orgdiv{Department}, \orgname{University}, \orgaddress{\country{Country}}. \email{username@example.com}}
...
\begin{figure}[t]%
\FIG{\includegraphics[width=0.9\textwidth]{placeholder-figure}}
